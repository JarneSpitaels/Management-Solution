...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFF0A9782);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  Color tertiaryColor = const Color(0xFFEE8B60);
  Color alternate = const Color(0xFFFF5963);
  Color primaryBackground = const Color(0x39000000);
  Color secondaryBackground = const Color(0xFF1D2429);
  Color primaryText = const Color(0xFFF9F9F9);
  Color secondaryText = const Color(0xFFF9F9F9);
}
