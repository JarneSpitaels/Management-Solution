...
class AddUsersToChatWidget extends StatefulWidget {
  const AddUsersToChatWidget({
    Key key,
    this.chat,
  }) : super(key: key);
  ...
  @override
  _AddUsersToChatWidgetState createState() => _AddUsersToChatWidgetState();
}

class _AddUsersToChatWidgetState extends State<AddUsersToChatWidget>
